...
<html lang="en">
	<head>
		...
		<title>Sanza - Onepage Multipurpose Bootstrap HTML</title>
		<!-- Bootstrap core CSS -->
	...
	<body id="page-top">
			...
			<div class="container">
				<div class="slider-container">
					<div class="intro-text">
						...
						<a href="http://localhost:8080/page/login.html" class="page-scroll btn btn-xl">点击进入我们</a>
					</div>
				</div>
			</div>
		</header>
					...
					<div class="col-md-7">
						<div class="section-text">
							...
							<ul>
								...
								<li>MOOZTheme Do Things With Love</li>
							</ul>
						</div>
					</div>
					<div class="col-md-5">
		...
		<footer>
			<div class="container text-center">
				<p>Designed by <span>MOOZ</span>Themes - More Templates <a href="http://www.cssmoban.com/" target="_blank" title="模板之家">模板之家</a> - Collect from <a href="http://www.cssmoban.com/" title="网页模板" target="_blank">网页模板</a></p>
			</div>
		</footer>
